...
processed_bids = set()  # برای bid های ارسال شده
...
def process_buy(item_id, count, item_name, total_price):
    # ✅ اگه آیتم توی لیست نباشه، اصلا جواب نده
    if item_name not in LIMITS:
        push(f"❌ Unknown item: {item_name} - ignored", color=(1, 0.5, 0))
        return
